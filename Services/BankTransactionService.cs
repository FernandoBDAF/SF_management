...
public class BankTransactionService : BaseService<BankTransaction>
{
    ...
    public override async Task<List<BankTransaction>> List()
    {
    ...
    public async Task<BankTransaction> Approve(Guid bankTransactionId, BankTransactionApproveRequest model)
    {
    ...
    public async Task<(BankTransaction from, BankTransaction to)> Link(Guid fromBankTransactionId,
    ...
    public async Task<List<BankTransaction>> ListByClientIdAndBankId(Guid? clientId, Guid? bankId)
    {
