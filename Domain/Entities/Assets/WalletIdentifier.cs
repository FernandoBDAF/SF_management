...
public class WalletIdentifier : BaseDomain
{
    ...
    public AssetGroup AssetGroup
    {
        get
        {
            if (AssetPool != null)
                ...
                return WalletIdentifierValidationService.GetAssetGroupForAssetType(AssetType);
        }
    }
    ...
    public bool IsAssetTypeCompatibleWithAssetPool()
    {
        ...
        return WalletIdentifierValidationService.ValidateAssetTypeCompatibility(AssetType, AssetPool.AssetGroup);
    }
