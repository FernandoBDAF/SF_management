...
public class AuthenticationLoggingMiddleware
{
    ...
    public async Task InvokeAsync(HttpContext context)
    {
        ...
        // _logger.LogInformation("Authentication Debug - Path: {Path}, Method: {Method}, IsAuthenticated: {IsAuthenticated}, UserId: {UserId}, UserEmail: {UserEmail}",
        //     originalPath, method, isAuthenticated, userId ?? "null", userEmail ?? "null");
        ...
        {
            _logger.LogDebug("No Authorization header found for request: {Method} {Path}", method, originalPath);
        }
