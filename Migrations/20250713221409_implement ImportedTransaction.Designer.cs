...
namespace SFManagement.Migrations
{
    ...
    [Migration("20250713221409_implement ImportedTransaction")]
    partial class implementImportedTransaction
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SFManagement.Models.Transactions.BaseTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ImportedTransactions", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_ImportedTransaction_ReconciledAt_Logic", "([ReconciledTransactionId] IS NOT NULL AND [ReconciledAt] IS NOT NULL) OR ([ReconciledTransactionId] IS NULL AND [ReconciledAt] IS NULL)");
                        });
                });

            modelBuilder.Entity("SFManagement.Models.Transactions.DigitalAssetTransaction", b =>
                {
                    b.HasBaseType("SFManagement.Models.Transactions.BaseTransaction");
                    ...
                    b.HasDiscriminator().HasValue("DigitalAssetTransaction");
                });
            ...
            modelBuilder.Entity("SFManagement.Models.Transactions.FiatAssetTransaction", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("FiatAssetTransaction");
                });
            ...
            modelBuilder.Entity("SFManagement.Models.Transactions.SettlementTransaction", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("SettlementTransaction");
                });
            ...
            modelBuilder.Entity("SFManagement.Models.Transactions.ImportedTransaction", b =>
                {
                    ...
                    b.HasOne("SFManagement.Models.Transactions.BaseTransaction", "ReconciledTransaction")
                        .WithMany()
                        .HasForeignKey("ReconciledTransactionId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("BaseAssetHolder");

                    b.Navigation("ReconciledTransaction");
                });
